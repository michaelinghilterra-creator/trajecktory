...
const APPS = [
  ...
  { id: 405, date: '2026-07-08', company: 'Contoso Freight',     role: 'Director, Revenue Operations', score: 4.4, status: 'Offer',       archetype: 'RevOps',    sector: 'Logistics',  source: 'Lever',      compStated: '$141,000 - $158,000', url: 'https://jobs.example.com/contoso-dir-revops',   report: 'reports/405-contoso-freight-2026-07-08.md',    resume: 'trajecktory', seniority: 'Director', remote: 'Remote' },
  ...
  { id: 394, date: '2026-07-14', company: 'Initech Cloud',       role: 'Sr. Manager, Sales Ops',     score: 3.4, status: 'Evaluated',     archetype: 'SalesOps',  sector: 'SaaS',       source: 'Website',    compStated: '$137,000 - $163,500', url: 'https://jobs.example.com/initech-sr-mgr-salesops', report: 'reports/394-initech-cloud-2026-07-14.md',   resume: '',            seniority: 'Manager',  remote: 'Hybrid' },
  ...
  { id: 386, date: '2026-06-24', company: 'Vertex Foods',        role: 'RevOps Manager',             score: 3.1, status: 'Rejected',      archetype: 'RevOps',    sector: 'CPG',        source: 'Lever',      compStated: '$129,500 - $157,000', url: 'https://jobs.example.com/vertex-revops-mgr',    report: 'reports/386-vertex-foods-2026-06-24.md',       resume: 'trajecktory', seniority: 'Manager',  remote: 'Onsite' },
...
const CHEATSHEET = {
  ...
  comp: {
    ...
    verdict: 'Clears your target of $163,500 at the midpoint and clears your walk-away comfortably. Equity is unstated, so ask early.',
