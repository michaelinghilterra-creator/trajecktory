...
// Planned, not live. Code must not compare a status to one of these yet.
export const PLANNED_STATUSES = Object.freeze(['Passed']);
...
// is no longer true, so a fixed divergence has to be removed here.
export const KNOWN_DIVERGENCES = Object.freeze([
  {
    export: 'ACTIVE_STATUSES',
    file: 'dashboard-web/server/lib/statuses.mjs',
    extra: ['Evaluated'],
    note: 'The server treats the whole ladder as active. Definitions v1 says Evaluated is not active.',
  },
]);
