...
/** Interview lines the person still has to back with evidence, and those only arranged. */
export function interviewItems(interviews, today) {
  ...
  for (const line of Array.isArray(interviews) ? interviews : []) {
    ...
    if (line.date > today) scheduled.push(item);
    else if (line.evidence_ok !== true) unconfirmed.push(item);
  }
