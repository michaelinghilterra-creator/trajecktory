...
export function stripDraftMeta(s) {
  ...
  // The lazy [\s\S]{0,500}? also catches LLM reasoning sentences that precede the
  // preamble (e.g. "Reconnecting on LinkedIn is a light message. Here's the draft:").
  t = t.replace(/^[\s\S]{0,500}?Here(?:'s| is)(?: the| your| a)?\s+(?:connection (?:request )?note|message|draft|note|response|reply)[^:\n]{0,60}:\s*/i, '');
