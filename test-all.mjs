...
const scripts = [
  ...
  { name: 'audit-discards.mjs', expectExit: 0 },
...
for (const suite of [
  ...
  'tests/workflow-post-eval.test.mjs',
  'tests/rebuild-tracker-tsv.test.mjs',
  ...
  'tests/log-writes-touches.test.mjs',
  'tests/log-writes-scripts.test.mjs',
  'tests/log-writes-maintenance.test.mjs',
  ...
  'tests/pipeline-firstseen.test.mjs',
  'tests/triage-results.test.mjs',
  'tests/portal-additions.test.mjs',
  ...
  'tests/contact-discovery.test.mjs',
  ...
  'tests/sequences.test.mjs',
  'tests/cadence-start.test.mjs',
  ...
  'tests/contact-channel-bucket.test.mjs',
  'tests/due-sequence-contacts.test.mjs',
  'tests/stale-ta.test.mjs',
  'tests/linkedin-acceptance.test.mjs',
  'tests/target-talent-sequence-advance.test.mjs',
  ...
  'tests/interview-records.test.mjs',
  'tests/interview-dates.test.mjs',
  'tests/void-events.test.mjs',
  ...
  'tests/event-undo.test.mjs',
  'tests/undo-route.test.mjs',
  'tests/interview-schedule.test.mjs',
  'tests/interview-schedule-route.test.mjs',
  'tests/interview-outcome-route.test.mjs',
  'tests/weekly-review-builders.test.mjs',
