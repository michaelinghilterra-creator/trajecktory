...
for (const m of ['log-writes.mjs', 'event-store.mjs', 'event-store-switch.mjs', 'legacy-files.mjs', 'atomic-write.mjs']) {
...
function runMerge(seedRows, caseMap, extraFiles = {}) {
  ...
  for (const m of [
    ...
    'log-writes.mjs', 'event-store.mjs', 'event-store-switch.mjs', 'legacy-files.mjs', 'atomic-write.mjs',
  ]) {
