...
const seed = [
  ...
  '|---|------|---------|------|-------|--------|-----|--------|--------|-------|',
  L(9001, 'Acme', 'Director, Revenue Operations', 'v1 frontmatter report', '9001-acme-2026-07-01.md'),
  L(9002, 'Borealis', 'Head of Analytics', 'legacy URL header', '9002-borealis-2026-07-01.md'),
  L(9003, 'Cinder', 'VP Strategy', 'placeholder url', '9003-cinder-2026-07-01.md'),
  L(9004, 'Dunlin', 'Director, BI', 'report has no url', '9004-dunlin-2026-07-01.md'),
  L(9005, 'Eider', 'Manager, Sales Ops', 'report file is missing', '9005-eider-2026-07-01.md'),
