...
const cases = [
  ...
  ['Chief People Officer', 'revops', 'exec'],
  ['CHRO', 'revops', 'exec'],
  ['SVP People', 'revops', 'exec'],
  ['VP People', 'revops', 'exec'],
  ['VP Human Resources', 'revops', 'exec'],
  ['Head of People', 'revops', 'exec'],
  ['Director of People Operations', 'revops', 'ta'],
  ['HR Manager', 'revops', 'ta'],
  ['VP Talent Acquisition', 'revops', 'ta'],
  ['Head of Talent', 'revops', 'ta'],
  ['Recruiter', 'revops', 'ta'],
  ['Talent Partner', 'revops', 'ta'],
