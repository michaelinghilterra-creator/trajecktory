...
<!-- Captured via the Launchpad "Evaluation tuning" step. Priorities are ranked
     (what to optimize for); deal-breakers are hard filters that override score.
     Title- or keyword-shaped deal-breakers are also mirrored into
     portals.yml title_filter.negative so the scanner never surfaces them. -->

**Priorities (ranked — what to optimize for):**
1. <!-- e.g. roles where the work maps directly to measurable business outcomes -->
2. <!-- e.g. location / work-arrangement fit -->
3. <!-- e.g. total comp at or above target band -->

**Deal-breakers (hard nos — override score):**
- <!-- e.g. onsite outside your approved metro list -->
- <!-- e.g. excluded industries or company stages -->
