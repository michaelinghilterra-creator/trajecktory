...
> "No active applications to follow up on. Apply to some roles first with `/trajecktory` and come back when they're aging."
...
- Suggest the user run `/trajecktory contacto {company}` to find the right person first
...
> - Trying a different contact via `/trajecktory contacto`
...
**To:** {email or "No contact found — run `/trajecktory contacto` first"}
...
|--------|----------------|------------|-------------|
| Applied | 1-2 days after application | Every 5-7 days | 2 (then mark cold) |
