...
| Write | Temporary HTML for PDF, reports .md, tracker-additions TSV files |
| Bash | Update existing tracker rows with `node agent-edit.mjs application`; run `node generate-pdf.mjs` |
