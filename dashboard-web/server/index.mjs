...
import { router as discoveryRoutes } from './routes/discovery.mjs';
import { router as draftsRoutes } from './routes/drafts.mjs';
...
import { router as eventStoreRoutes } from './routes/event-store.mjs';
import { router as weeklyReviewRoutes } from './routes/weekly-review.mjs';
import { router as eventActionsRoutes } from './routes/event-actions.mjs';
import { router as notesRoutes } from './routes/notes.mjs';
import { router as cadenceRoutes } from './routes/cadence.mjs';
import { router as resumeCadenceRoutes } from './routes/resume-cadence.mjs';
import { router as todosRoutes } from './routes/todos.mjs';
import { router as postsRoutes } from './routes/posts.mjs';
import { router as bufferRoutes } from './routes/buffer.mjs';
import { router as coachRoutes } from './routes/coach.mjs';
...
app.use(eventStoreRoutes);
app.use(weeklyReviewRoutes);
app.use(eventActionsRoutes);
app.use(notesRoutes);
app.use(cadenceRoutes);
app.use(resumeCadenceRoutes);
app.use(todosRoutes);
app.use(postsRoutes);
